...
<template>
    <el-table
        :data="((flag) ? useUserStore().user.img : useImgStore().userImgs)[0] != null ? (flag) ? useUserStore().user.img : useImgStore().userImgs : null"
        :border=true style="width: 80%;margin: 0 auto;height: 500px;">
