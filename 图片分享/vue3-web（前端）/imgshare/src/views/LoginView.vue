...
<template>
    <el-row>
        ...
        <el-col :span="13" class="right"><el-form ref="loginFormRef" :model="loginForm" :rules="rules"
                label-width="auto" label-position="top" :hide-required-asterisk=true>
                <el-form-item label="用户名" prop="uname">
                    <el-input v-model="loginForm.uname" />
                </el-form-item>
                <el-form-item label="密码" prop="pwd">
                    <el-input v-model="loginForm.pwd" type="password" @keydown.enter="submitForm(loginFormRef)" />
                </el-form-item>
                <el-form-item>
                ...
                <router-link to="register"><el-link type="primary"
                        style="margin-left: 2rem;">还没注册？点我点我</el-link></router-link>
